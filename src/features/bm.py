...
print 'Graph minors A survey'.strip().split(' ')
raw_data = set([])
raw_data = raw_data | set([x for x in 'Graph minors A survey'.strip().split(' ')])
dictionary.add_documents(np.asarray(list(raw_data)))
